	...
	protected function render() {
		...
		<div class="<?php echo ld_helper()->sanitize_html_classes( $wrapper_class ); ?>" id="<?php echo esc_attr($parent) ?>" role="tablist" aria-multiselectable="true">
			...
			<div class="accordion-item panel <?php echo $active; ?>">
				...
				<?php printf( '<%1$s class="accordion-title %2$s">', $settings['title_tag'], $settings['use_inheritance'] === 'true' ? $settings['tag_to_inherite'] : '' ); ?>
					<a class="<?php echo $collapsed ?>" role="button" data-toggle="collapse" 
					data-parent="#<?php echo $parent ?>" href="#<?php echo 'collapse-'.$id_int . $tab_count ?>" 
				...
				<div id="<?php echo 'collapse-'.$id_int . $tab_count ?>" class="accordion-collapse collapse <?php echo $in ?>" role="tabpanel" aria-labelledby="<?php echo 'heading-'.$id_int . $tab_count; ?>">
